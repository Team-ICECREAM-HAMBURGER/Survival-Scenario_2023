...
public class PlayerBehaviourEventInjured : MonoBehaviour, IPlayerBehaviourEvent {
    public float Weight { get; set; }

    private StringBuilder resultText; 
    
    
    public PlayerBehaviourEventInjured(float weight) {
        this.Weight = weight;
    ...
    public void Event() {
        ...
        // Event
        PlayerBehaviourSearchView.OnSearchResultUIInjured(Injured());
    }
